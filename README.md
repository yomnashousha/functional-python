# Functional Python [![](https://github.com/yomnashousha/functional-python/workflows/tests/badge.svg)](https://github.com/yomnashousha/functional-python/actions?query=workflow%3Atests)
